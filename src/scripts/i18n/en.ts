export const en = {
  ...
  landing: {
    ...
    hero_subtitle: "Unleash the power of <strong>Google Nano Banana</strong> models to turn your ideas into striking YouTube thumbnails.",
    cta_start: "Start Now",
    cta_pricing: "See Pricing",
    badge_free: "Free (Interface)",
    badge_byok: "BYOK (Replicate / Gemini)",
    badge_new: "NEW",
    badge_new_desc: "x4 Generation & Nano Banana 2",
    open_source: "Open Source. Today and Forever.",
    features_title: "Why Choose NanoThumbnail?",
    feature_1_title: "2 Google Models",
    feature_1_desc: "Choose between <strong>Nano Banana Pro</strong> (maximum quality) and <strong>Nano Banana 2</strong> (fast and affordable). Two Google models that excel in text rendering and photo realism.",
    ...
    pricing: {
      ...
      badge: "BEST OFFER",
      pay_per_use: "Pay as you go (from ~$0.02/img)",
    ...
    step_2_title: "The AI",
    step_2_desc: "Nano Banana generates your thumbnail in high definition. Generate 1 or 4 variations in parallel to compare.",
    ...
    faq_1_a: "The NanoThumbnail interface is 100% free. Image generation uses the Replicate or Google Gemini API (paid). Price depends on the model: ~$0.14 with Nano Banana Pro, much less with Nano Banana 2. You pay the provider directly.",
    ...
    faq_4_q: "What's the difference between the two models?",
    faq_4_a: "<strong>Nano Banana Pro</strong> offers the best image quality, ideal for polished thumbnails. <strong>Nano Banana 2</strong> (Gemini 3.1 Flash) is optimized for speed and volume, perfect for rapid iteration. Both excel at text rendering.",
    whats_new: {
      title: "What's New?",
      ...
      smart_settings_desc: "Tabbed sidebar (Create / References / History), keyboard shortcut ⌘↵ and settings always accessible.",
      smart_settings_tag: "Clean & fast",
      multi_gen_title: "x4 Generation",
      multi_gen_desc: "Generate 4 thumbnails in parallel with the same prompt. Compare, pick the best one and download in one click.",
      multi_gen_tag: "Compare & choose"
    },
  ...
  app: {
    ...
    sidebar_ref: "Reference images",
    drop_text: "Click or drag images here",
    sidebar_settings: "Settings",
    label_model: "Model",
    opt_model_pro: "Nano Banana Pro (Quality)",
    opt_model_2: "Nano Banana 2 (Fast)",
    ...
    images: "images",
    empty_title: "Create your thumbnail",
    empty_subtitle: "Describe your idea and let AI create a striking YouTube thumbnail",
